...
- You must have up to Question 2 completed for the homework check on November 16
...
> **Complete up to here for Homework Check** - due November 16th at 11:59 pm.
...
### 4a. Investigating `average_rating` vs. `price` and `rating_number`
