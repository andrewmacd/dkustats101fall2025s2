...
webr:
  ...
  packages:
    ...
    - knitr
  resources:
    - https://raw.githubusercontent.com/andrewmacd/dkustats101fall2025s2/main/lectures/datasets/nba2024.2025.csv
    - https://raw.githubusercontent.com/andrewmacd/dkustats101fall2025s2/main/lectures/datasets/titanic.survival.csv
...
nbaboxscores %>% 
    filter(AST > 40) %>%
    select(game_id, team_id, home.away, PTS, REB, gameDate)
```
