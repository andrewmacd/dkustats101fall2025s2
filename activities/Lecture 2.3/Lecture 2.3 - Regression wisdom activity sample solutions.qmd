...
ggplot(hurricanes, aes(x=LF.WindsKPH, y=BaseDam2014)) +
  geom_point() +
...
ggplot(hurricanes, aes(x=LF.WindsKPH, y=log.dmg.2014)) +
  geom_point() +
...
> A two log-unit change in predicted damage is realtively large given the Q1 to Q3 of the response variable goes from roughly 4 to 8.
